;;; fb-coding-style.el: Facebook-specific coding styles
...
(defconst fb-c-style
  '((c-basic-offset . 2)
    ...
    (c-hanging-braces-alist . ((arglist-cont-nonempty after)
    ...
    (c-offsets-alist . (;; indent for public: protected: private:
